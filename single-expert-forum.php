    ...
    <div class="container">
        <div class="row">
            ...
            <div class="forum-page mt-2">
                <?php get_template_part( 'template-parts/forum', 'expert-single', $data); ?>
                </div>
            </div>
        </div>
    </div>
...
wp_register_script( 'forum-single-js', get_stylesheet_directory_uri() . '/assets/js/forum-single.js', false );
...
wp_enqueue_script( 'forum-single-js' );
wp_localize_script( 'forum-single-js', 'sf_object',
    array( 
