...
$goBackActionLink = ( get_the_permalink( learndash_get_lesson_id() ) ) ?: '';
    ...
    <header class="flex justify-between items-center">
        <section class="heading-section">
            ...
            <div class="d-flex gap-4 items-center">
                <h1 class="text-[32px] text-[#161C24] lh-sm font-bold mb-0 pb-0"><?= $headerTitle; ?></h1>
                <button id="tour-popup" class="btn btn-primary topics">Begin Tour</button>
            </div>
                        ...
                        <div class="main-container">
                            <div class="heading-area flex justify-between items-center">
                                <div class="heading-area-left flex justify-between items-center">
                                    ...
                                    <h2 class="test entry-title pl-[12px] text-[24px] text-[#161C24] leading-10 font-bold mb-0 pb-0"><?php echo get_the_title( learndash_get_course_id() ); ?></h2>
                                </div>
                                <?php
                            ...
                            <div id="content-area" class="clearfix">
                                ...
                                <?php while ( have_posts() ) : the_post(); ?>
                                    ...
                                    <?php get_template_part('template-parts/topic', 'bottom');?>
                                <?php endwhile; ?>
                                </div>
