        ...
        <div class="col-md-9">
            <div class="header d-flex justify-content-between">
                <div class="title flex-1">
                    <h4 class="fw-bold fs-3 text-[#161C24] p-0 m-0">All Forums</h4>
                </div>
            ...
            <div class="forums">
                <?php
                $paged = ( get_query_var( 'peer' ) ) ? get_query_var( 'peer' ) : 1;
                ...
                if(isset(($_POST['topic-search']))){
                    $args['s'] = sanitize_text_field($_POST['topic-search']);
                }
                ...
                if($topic_query -> have_posts()){
                    ...
                    <div class="chats-emtpy my-3 items-center text-center d-flex flex-column">
                        ...
                        <p class="text-[#4d4f4e]">
                            <?php if (isset(($_POST['topic-search']))){
           ...
           <div class="pagination d-flex gap-2 items-center justify-content-center mt-3">
                ...
                echo paginate_links( array(
                    ...
                    'base' => add_query_arg( 'peer', '%#%' ),
                    'format' => '?peer=%#%',
                    'current' => max( 1, get_query_var('peer') ),
                    'total' => $total,
