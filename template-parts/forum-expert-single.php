        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="forum-topic-single-body my-3">
                    ...
                    <!-- <h2 class="fw-bold fs-4 text-[#4D4F4E] mb-2"><?php // the_title();?></h2> -->
                    ...
                    <div class="forum-topic-single-bottom pb-3 mt-3 d-flex justify-content-between items-center border-bottom">
                        <div class="question-action d-flex gap-2">
                            ...
                            <button class="curr-qus-ans d-flex gap-1 border-1 rounded-3 px-2 py-1 border align-items-center"><img src="<?php echo get_stylesheet_directory_uri() . '/assets/svg/comment.svg';?>" alt="comment" srcset="">Answer <span class="comment-count"><?php echo get_comments_number();?></span>
                            </button>
