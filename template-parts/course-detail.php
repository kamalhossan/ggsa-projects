...
$goBackActionLink = ( get_field('goback_button_link', 'option') ) ?: '';
...
?>
<main class="px-6 py-8 bg-[#F6F6F6] <?= $termSlug; ?>">
                        ...
                        <div class="main-container">
                            <div class="heading-area flex justify-between items-center">
                                <div class="heading-area-left flex justify-between items-center">
                                    ...
                                    <h2 class="entry-title pl-[12px] text-[24px] text-[#161C24] leading-10 font-bold mb-0 pb-0"><?php the_title(); ?></h2>
                                </div>
                                <?php
                                    if( $termSlug != 'professional-learning' ) {
